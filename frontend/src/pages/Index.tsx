...
const FLOAT_ICONS = [
  { icon: "🧠", x: "5%",  y: "10%", size: "2rem",   dur: "6s",   delay: "0s"   },
  { icon: "💼", x: "90%", y: "8%",  size: "1.7rem",  dur: "8s",   delay: "1s"   },
  { icon: "🎙️", x: "15%", y: "40%", size: "2.2rem",  dur: "7s",   delay: "2s"   },
  { icon: "📄", x: "80%", y: "35%", size: "1.8rem",  dur: "9s",   delay: "0.5s" },
  { icon: "🤖", x: "50%", y: "12%", size: "2rem",    dur: "10s",  delay: "3s"   },
  { icon: "📊", x: "70%", y: "65%", size: "1.6rem",  dur: "6.5s", delay: "1.5s" },
  { icon: "⭐", x: "25%", y: "75%", size: "1.5rem",  dur: "8.5s", delay: "4s"   },
  { icon: "🎯", x: "88%", y: "75%", size: "2rem",    dur: "7.5s", delay: "2.5s" },
  { icon: "🚀", x: "40%", y: "80%", size: "1.8rem",  dur: "9.5s", delay: "0.8s" },
  { icon: "💡", x: "3%",  y: "65%", size: "1.7rem",  dur: "7s",   delay: "3.5s" },
  { icon: "📝", x: "60%", y: "45%", size: "1.5rem",  dur: "11s",  delay: "1.2s" },
  { icon: "🏆", x: "35%", y: "25%", size: "1.6rem",  dur: "8s",   delay: "2.2s" },
  { icon: "💬", x: "93%", y: "50%", size: "1.7rem",  dur: "6s",   delay: "4.5s" },
  { icon: "🔍", x: "10%", y: "88%", size: "1.5rem",  dur: "9s",   delay: "0.3s" },
  { icon: "⚡", x: "75%", y: "18%", size: "1.4rem",  dur: "5.5s", delay: "3.8s" },
];
    ...
    <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      <style>{`
        @keyframes floatIcon {
          ...
          25%  { transform: translateY(-18px) rotate(4deg);  opacity: 0.45; }
          50%  { transform: translateY(-8px)  rotate(-3deg); opacity: 0.35; }
          75%  { transform: translateY(-22px) rotate(5deg);  opacity: 0.40; }
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <button
              ...
              className={`text-sm font-bold transition-colors ${
                showDashboard ? "text-primary" : "text-muted-foreground hover:text-foreground"
              }`}
            >
              DashBoard
            </button>
      ...
      {/* ── Main Content ── */}
      <main className="relative z-10 pt-24 lg:pt-32 transition-all duration-500">
              ...
              {!isLoggedIn && (
                <section className="relative overflow-hidden pt-8 pb-16 text-center animate-in fade-in duration-700">
                  ...
                  <h1 className="mx-auto max-w-4xl text-5xl font-extrabold leading-[1.1] tracking-tight sm:text-6xl lg:text-7xl">
                    ...
                    <span className="text-primary underline decoration-black decoration-4 underline-offset-8">
                  ...
                  <div className="mt-10">
                    <Button
                      size="lg"
                      className="glow-primary px-10 py-7 text-lg font-bold rounded-2xl"
                ...
                <section id="features-preview" className="py-12 border-t border-border/50">
                  ...
                  <div className="mx-auto grid max-w-6xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {featuresData.map((feature) => (
                      <div
                        key={feature.title}
                        className="group rounded-[2rem] border-2 border-border/50 bg-card p-8 hover:border-primary/50 transition-all cursor-pointer"
                        onClick={handleFeaturesNavigation}
                      >
      ...
      <footer className="relative z-10 border-t border-border/50 py-12 bg-muted/20">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-6 gap-6 text-sm text-muted-foreground">
          ...
          <div className="font-bold uppercase tracking-widest opacity-40 text-[10px]">
            Built with AI · 2026
          </div>
        </div>
      </footer>
